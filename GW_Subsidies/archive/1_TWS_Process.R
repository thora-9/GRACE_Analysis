...
cur_dir = "~/Dropbox/WB/GRACE_Analysis"
...
#Estimate the new baseline
sd_tws = apply(tws_lwe[, 4:164], 1, sd) 
...
#fwrite(tws_lwe_base, "GRACE_TWS_scaled_220203.csv")
...
#WRITE OUTPUT CSV
# fwrite(sws_anomaly, "Output/GLDAS_NOAH_02_17_SWS_wRunoff_220203.csv")
# fwrite(tws_anomaly, "Output/GRACE_TWS_scaled_220203.csv")
# fwrite(gws_anomaly, "Output/GRACE_GWS_2002_2017_wRunoff_220203.csv")
